...
func (app *Application) listenAndServe() {
	...
	mux.HandleFunc("/similarity", app.handleSimilarity)
...
func (app *Application) handleSimilarity(w http.ResponseWriter, r *http.Request) {
	userPub := r.URL.Query().Get("pubkey")
	app.service.GetSimilarity(userPub)
